...
// --- mobj.flags7 ---
	...
	MF8_DONTMEDAL		= 0x00080000,	// [geNia] Don't grant medals when using this weapon or projectile

	// [Ivory] extra movement flags
	MV_CPMAIRCONTROL	= 0x00000001,
	MV_CROUCHSLIDE		= 0x00000002,
	MV_WALLJUMP			= 0x00000004,
	MV_WALLJUMPV2		= 0x00000008,
	MV_DOUBLETAPJUMP	= 0x00000010,
	MV_WALLCLIMB		= 0x00000020,
	MV_EDGEJUMP			= 0x00000040,
	MV_SILENT			= 0x00000080,
	MV_ELEVATORJUMP		= 0x00000100,
	MV_AIRWALLRUN		= 0x00000200,
	MV_USER4JUMP		= 0x00000400,
	MV_GROUNDSECONDJUMP	= 0x00000800,
	MV_ABSOLUTESECONDJUMP	= 0x00001000,
...
{
public:
	const static LONG MIN_NETID = 65000l;
	const static LONG MAX_NETID = 100000l;
	const static LONG MAX_NETID_FOR_PLAYER = 1000l;
...
public:
	...
	LONG getNewID ( player_t* ownerPlayer );
